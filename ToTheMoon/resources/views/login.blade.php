      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form class="px-md-2" action="{{ route('login.custom') }}" method="post">
            @csrf
              ...
              <div class="mb-2">
                <p class="mb-1">Don't have an account? <b><u><a style="color: #393f81;" href="{{ route('register') }}" style="color: #1b2382;">Click here</a></u></b></p>
